...
export type NavItem = 'dashboard' | 'navigation' | 'toolbox' | 'automation' | 'skillCenter' | 'cheatsheet' | 'vault' | 'clipboard' | 'timeauditor' | 'visualrecall' | 'settings'
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'skillCenter', labelKey: 'nav.skillCenter', icon: <Box className="h-5 w-5" /> },
